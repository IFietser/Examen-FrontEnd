      ...
      <Row className="justify-content-center my-4">
        <Col xs={12} className="text-center mb-4">
          <h1 className="home-title">
            Encuentra hasta 4930 oportunidades de negocio en todo Chile
          </h1>
        </Col>
        ...
        <Col xs={12} className="text-center">
          <h2 className="home-subtitle">Bienvenido a LicitaSeguros</h2>
          <p className="home-desc">
            Plataforma para consultar licitaciones, proveedores y más.
          </p>
